...
def main():
    ...
    parser.add_argument("--train_batch_size", default=3, # 32
    ...
    if args.do_predict and (args.local_rank == -1 or torch.distributed.get_rank() == 0):
        ...
        output_prediction_file = os.path.join(
            args.output_dir, "predictions_bm_40_hy_10_epoch_2_ranker_epoch_2_beam_10.json")
        output_nbest_file = os.path.join(
            args.output_dir, "nbest_predictions")
        output_null_log_odds_file = os.path.join(
            args.output_dir, "null_odds")
        write_predictions_yes_no_no_empty_answer(eval_examples, eval_features, all_results,
                                                 ...
                                                 args.no_masking)
        # write_predictions_yes_no_beam(eval_examples, eval_features, all_results,
        #                               args.n_best_size, args.max_answer_length,
        #                               args.do_lower_case, output_prediction_file,
        #                               output_nbest_file, output_null_log_odds_file, args.verbose_logging,
        #                               args.version_2_with_negative, args.null_score_diff_threshold,
